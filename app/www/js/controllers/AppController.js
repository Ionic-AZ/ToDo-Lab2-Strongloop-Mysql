...
AppController.$inject = ['$scope', '$ionicModal', '$ionicSideMenuDelegate', 'Projects', '$rootScope',
	'$state', 'Auth_Events'];
function AppController($scope, $ionicModal, $ionicSideMenuDelegate, Projects, $rootScope, $state, Auth_Events) {
